...
namespace TechsysLog.Infra
{
    public static class Utils
    {
        ...
        /// <summary>
        /// Converte object em tipo DateTime
        /// </summary>
        ...
        /// <summary>
        /// Substitui Caracteres Que podem quebrar uma string no banco de dados
        /// </summary>
        /// <param name="strline"></param>
        /// <returns>string</returns>
        public static string RemoverQuebraString(string strline)
        {
            ...
            var alt = '\r';
            var enter = '\n';
            strline.Replace(tab.ToString(), " ").Replace(alt.ToString(), " ").Replace(enter.ToString(), " ");
        ...
        */
        ...
        {
            // Use uma expressão regular para encontrar apenas os números
        ...
        public static String AdicionarTextoHistoricoPax(String textoNovo, String textoAntigo)
        {
            try
            {
                var textoBlog = textoAntigo;
                var separador = "----------------------------------------------------------------------";
                var espacoNome = "          ";
                var textoHistorico = textoNovo;
                var quebralinha = "\n";
                var dataHora = DateTime.Now;

                var newBlog = separador + quebralinha + espacoNome + dataHora + quebralinha + textoHistorico + quebralinha + textoBlog;
