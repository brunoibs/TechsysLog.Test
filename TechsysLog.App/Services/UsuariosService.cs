...
namespace TechsysLog.App.Services
{
    public class UsuariosService : IUsuariosService
    {
        ...
        public async Task<IContractResult> Insert(Usuarios model)
        {
            var result = new ContractResult();
            try
            {
        ...
        public async Task<IContractResult> Update(Usuarios model)
        {
            var result = new ContractResult();
            try
            {
        ...
        public async Task<IContractResult> ObterPorLogin(Usuarios login)
        {
            var result = new ContractResult();
            try
            {
                var obj = _repo.ObterPorLogin(login);
                result.Valid = true;
                result.Message = "Sucesso.";
                result.Data = obj;
            }
