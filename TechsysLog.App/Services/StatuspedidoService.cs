...
namespace TechsysLog.App.Services
{
    ...
    {
        private readonly IStatuspedidoRepository _repo;
        public StatuspedidoService(IStatuspedidoRepository repo)
        {
            _repo = repo;
        }
        ...
        public async Task<IContractResult> Insert(StatusPedido model)
        {
            var result = new ContractResult();
            try
            {
        ...
        public async Task<IContractResult> Update(StatusPedido model)
        {
            var result = new ContractResult();
            try
            {
